...
#include "Layers/xrRenderDX10/dx10TextureUtils.h"
...
void CRenderTarget::u_setrt(const ref_rt& _1, const ref_rt& _2, const ref_rt& _3, ID3DDepthStencilView* zb)
{
    ...
    else
    {
        ...
        curWidth = TexDesc.Width;
        curHeight = TexDesc.Height;
        _RELEASE(pRes);
    }
...
BOOL CRenderTarget::Create()
{
    ...
    {
        rt_Depth.create(r1_RT_depth, rtWidth, rtHeight, HW.Caps.fDepth, 1, { CRT::CreateSurface });
    }
    else
    {
    ...
    rt_temp_zb.create(rt_RT_temp_zb, 512, 512, HW.Caps.fDepth, 1, { CRT::CreateSurface });
...
void CRenderTarget::phase_distortion()
{
    ...
    FLOAT ColorRGBA[4] = { 127, 127, 127, 127 };
    HW.pContext->ClearRenderTargetView(rt_distort->pRT, ColorRGBA);
