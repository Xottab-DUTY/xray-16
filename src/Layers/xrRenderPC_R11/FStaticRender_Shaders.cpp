    ...
    T*& result, bool const disasm)
{
    ...
    {
        result->constants.dx9compatibility = true;
...
HRESULT CRender::shader_compile(pcstr name, IReader* fs, pcstr pFunctionName, pcstr pTarget, u32 Flags, void*& result)
{
    ...
    strconcat(sizeof(filename), filename, "r11" DELIMITER, name, ".", extension);

    string_path folder_name, folder;

    strconcat(sizeof(folder), folder, "r11" DELIMITER "objects" DELIMITER, filename);
